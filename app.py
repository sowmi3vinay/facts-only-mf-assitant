"""Streamlit UI for the Facts-Only MF Assistant for Kuvera (Root Entrypoint)."""
...
# Trace startup
print("DEBUG: Root app.py starting...")
...
if CLOUD_LIGHT_MODE:
    st.info("☁️ Running in **Cloud Light Mode** (Keyword Search enabled).")
else:
    st.success("💻 Running in **Local Mode** (Full Semantic Search enabled).")
